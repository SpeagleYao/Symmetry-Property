...
parser.add_argument('--save-dir', type=str, default='log_resnet_AT')
parser.add_argument('--resume', choices=['vallina', 'finetune'], default='vallina')
args = parser.parse_args()

def attack(model, img, label, eps=0.03, iters=10, step=0.007):
    adv = img.detach()
...
log_filename = 'resnet18_AT_SCE.txt'
...
def train(epoch):
    ...
    torch.save(model.state_dict(), '../checkpoint/resnet18_AT/resnet18_AT_SCE.pth')
