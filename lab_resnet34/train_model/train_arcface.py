...
from models import ArcMargin_ResNet18
...
sys.stdout = Logger(os.path.join(args.save_dir, 'resnet18_arcmargin' + '.txt'))
...
model = ArcMargin_ResNet18(s=30,m=0.5)
if args.cuda:
    model.cuda()
...
def train(epoch):
    ...
    torch.save(model.state_dict(), '../checkpoint/resnet18/resnet18_arcmargin.pth')
