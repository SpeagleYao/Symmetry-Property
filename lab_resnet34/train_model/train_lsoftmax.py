...
from models import Lsoftmax_ResNet18
...
sys.stdout = Logger(os.path.join(args.save_dir, 'resnet18_lsoftmax' + '.txt'))
...
model = Lsoftmax_ResNet18(margin=2)
if args.cuda:
    model.cuda()
...
def train(epoch):
    ...
    torch.save(model.state_dict(), '../checkpoint/resnet18/resnet18_lsoftmax.pth')
