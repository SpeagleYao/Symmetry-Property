...
from models import AddMargin_ResNet34
...
sys.stdout = Logger(os.path.join(args.save_dir, 'resnet34_addmargin' + '.txt'))
...
model = AddMargin_ResNet34(s=10,m=0.8)
if args.cuda:
    model.cuda()
...
def train(epoch):
    ...
    torch.save(model.state_dict(), '../checkpoint_res/checkpoint/resnet34_addmargin_s10_m0.8.pth')
