...
from models import Lsoftmax_VGG16
...
sys.stdout = Logger(os.path.join(args.save_dir, 'vgg16_lsoftmax1' + '.txt'))
...
def train(epoch):
    ...
    torch.save(model.state_dict(), '../checkpoint/vgg16n/vgg16_lsoftmax1.pth')
