...
parser.add_argument('--log-interval', type=int, default=999, metavar='N',
                help='how many batches to wait before logging training status')
parser.add_argument('--save-dir', type=str, default='log_ablation')
...
log_filename = 'vgg16_a{}_d{}.txt'.format(args.alpha, args.delta)
...
def train(epoch):
    model.train()
    bar = progressbar.ProgressBar(max_value=50000//args.batch_size)
    ...
    filename = '../cp_ablation/vgg16_a{}_d{}.pth'.format(args.alpha, args.delta)
