...
sys.stdout = Logger(os.path.join(args.save_dir, 'vgg16_center' + '.txt'))
...
criterion_center = CenterLoss(num_classes=10, feat_dim=512, use_gpu=args.cuda)
...
def train(epoch):
    ...
    torch.save(model.state_dict(), '../checkpoint/vgg16n/vgg16_center.pth')
