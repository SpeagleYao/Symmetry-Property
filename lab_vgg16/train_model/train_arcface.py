...
from models import ArcMargin_VGG16
...
parser.add_argument('--save-dir', type=str, default='logn')
...
sys.stdout = Logger(os.path.join(args.save_dir, 'vgg16_arcmargin' + '.txt'))
...
model = ArcMargin_VGG16(s=64,m=0.5)
if args.cuda:
    model.cuda()
...
def train(epoch):
    ...
    torch.save(model.state_dict(), '../checkpoint/vgg16n/vgg16_arcmargin1.pth')
