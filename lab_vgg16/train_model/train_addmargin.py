...
from models import AddMargin_VGG16
...
sys.stdout = Logger(os.path.join(args.save_dir, 'vgg16_addmargin' + '.txt'))
...
model = AddMargin_VGG16(s=10,m=0.8)
if args.cuda:
    model.cuda()
...
def train(epoch):
    ...
    torch.save(model.state_dict(), '../checkpoint/vgg16n/vgg16_addmargin1.pth')
