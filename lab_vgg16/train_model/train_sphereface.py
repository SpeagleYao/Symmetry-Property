...
from models import SphereProduct_VGG16
...
sys.stdout = Logger(os.path.join(args.save_dir, 'vgg16_sphereproduct' + '.txt'))
...
def train(epoch):
    ...
    torch.save(model.state_dict(), '../checkpoint/vgg16/vgg16_sphereproduct.pth')
